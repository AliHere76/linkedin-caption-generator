            ...
            >
              ...
              <div className="space-y-6">
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-foreground">
                  Welcome to <span className="gradient-text">Linked Wizard</span>
                </h1>
                  ...
                  {/* Sign In Tab */}
                            ...
                            >
                              ...
                              <Button
                                ...
                                className="w-full h-12 text-base font-semibold border-border hover:bg-secondary transition-all duration-300 hover:scale-[1.02] hover:border-orange-500/50 hover:shadow-md"
                              >
